...
public class setplayergmlevel implements ChatCommandExecutor {
	 private Map<String, Character> names = new HashMap<String, Character>();
	
	public void execute(String[] parameters, Connection source) {
		//System.out.println("Handling change character gm level command");
		for(int i=0;i<parameters.length;i++) {
			//System.out.println("Command param[" + (i+1) + "] : " + parameters[i]);
				...
				anyplayer.setChargm(parameters[1]);
				CharacterDAO.changeplayergmlevel(parameters[1], anyplayer.getLOGsetName());
