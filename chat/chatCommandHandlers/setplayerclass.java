...
public class setplayerclass implements ChatCommandExecutor {
	...
	public void execute(String[] parameters, Connection source) {
		...
		for(int i=0;i<parameters.length;i++) {
			//System.out.println("Command param[" + (i+1) + "] : " + parameters[i]);
				...
				anyplayer.setCharacterClass(Integer.parseInt(parameters[1]));
				CharacterDAO.changeplayerClass(Integer.parseInt(parameters[1]), anyplayer.getLOGsetName());
