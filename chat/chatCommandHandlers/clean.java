...
public class clean implements ChatCommandExecutor {
				...
				Character cur = ((PlayerConnection)con).getActiveCharacter();
						...
						byte[] cha = new byte[] {
							...
							healpckt[18] = (byte)cur.guild.getguildranks(Key); //guild rank idk why
									...
									cur.joinGameWorld();	
									Charstuff.getInstance().respondguild("Showing Inv, Cargo, Friends, Skills, Skillbar is back to Normal.", cur.GetChannel());		
